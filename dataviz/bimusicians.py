...
df = pd.read_csv("datasets/bimusicians.csv")
...
def process(d):
    ...
    return Image.from_column([
      ...
      Image.from_text("({})".format(d['years']), arial(16, bold=False), padding=(2, 2, 2, 5), fg="white", bg="black"),
      ])

title = Image.from_column([
    Image.from_text(f"bicons: 20 bisexual music icons".upper(), arial(48, bold=True), fg="white", bg="black")
...
img.save("output/bimusicians.png")
