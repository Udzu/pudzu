...
legend = generate_legend(PALETTE[:len(CATEGORIES)], DESCRIPTIONS, header="Etymologies", footer=FOOTER, box_sizes=[(40,40 if len(d)<90 else 60) for d in DESCRIPTIONS], max_width=320)
