...
df = pd.read_csv("datasets/etymvaccine.csv").set_index("language")
...
PALETTE = [PairedClass12.RED, PairedClass12.BLUE, PairedClass12.GREEN ]
CATEGORIES = ["v", "a", "o"]
...
legend = generate_legend(PALETTE[:len(CATEGORIES)], DESCRIPTIONS, box_sizes=(40,...), font_family=partial(FONT, 16))
chart = map.place(legend, align=(1,0))

title = Image.from_column([
Image.from_text("VACCINE IN DIFFERENT EUROPEAN LANGUAGES", FONT(48, bold=True)),
...
img.save("output/etymvaccine.png")
