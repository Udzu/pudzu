...
def box(c): return Image.new("RGBA", (50, 25), colorfn(c)).place(Image.from_text(label_fn(c), arial(16, bold=True), "black", bg=colorfn(c)))

flag_leg = Image.from_array([[flag('UK'), Image.from_text("original", arial(16))],
[box('UK'), Image.from_text("average", arial(16))]
], bg="white", xalign=0, padding=(5,5))

note_leg = Image.from_text("Flags images from Wikipedia. Names are short English names.", arial(16), max_width=120, bg="white", padding=(0,2))
