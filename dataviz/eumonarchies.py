...
year_leg = Image.from_column([Image.from_text("Monarchy abolished", arial(font_size, bold=True)), year_arr], bg="white", xalign=0, padding=(0,5))
...
Image.from_text("monarchy abolition in Europe", arial(36))],
bg="white")
