...
df = pd.read_csv("datasets/flagsbc.csv")
...
title = Image.from_text(f"Flags with distinct Dark & Light Blue".upper(), FONT(80, bold=True), fg=fg, bg=bg).pad(40, bg)
