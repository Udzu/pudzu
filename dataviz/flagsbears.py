...
df = pd.read_csv("datasets/flagsbears.csv")
...
title = Image.from_text(f"flags with bears".upper(), FONT(80, bold=True), fg=fg, bg=bg).pad(40, bg)
...
img.save("output/flagsbears.png")
