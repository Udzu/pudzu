...
df = pd.read_csv("datasets/flagsblack.csv")
...
title = Image.from_text("Some black and white flags".upper(), FONT(80, bold=True), fg=fg, bg=bg).pad(40, bg)
...
img.save("output/flagsblack.png")
