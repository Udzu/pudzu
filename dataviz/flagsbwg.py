...
df = pd.read_csv("datasets/flagsbwg.csv")
...
title = Image.from_text("Blue, White & Green flags".upper(), FONT(96, bold=True), fg=fg, bg=bg).pad(40, bg)
