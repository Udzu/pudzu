...
df = pd.read_csv("datasets/flagsbwk.csv")
...
title = Image.from_text("Blue, White & Black flags".upper(), FONT(96, bold=True), fg=fg, bg=bg).pad(40, bg)
