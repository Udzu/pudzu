...
df = pd.read_csv("datasets/flagsdinosaurs.csv")
...
title = Image.from_text(f"flags with dinosaurs".upper(), FONT(80, bold=True), fg=fg, bg=bg).pad(40, bg)
...
img.save("output/flagsdinosaurs.png")
