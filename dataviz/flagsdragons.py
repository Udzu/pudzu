...
df = pd.read_csv("datasets/flagsdragons.csv")
...
title = Image.from_text(f"flags with dragons".upper(), FONT(80, bold=True), fg=fg, bg=bg).pad(40, bg)
...
img.save("output/flagsdragons.png")
