...
df = pd.read_csv("datasets/flagsfoxes.csv")
...
title = Image.from_text(f"flags with foxes".upper(), FONT(80, bold=True), fg=fg, bg=bg).pad(40, bg)
...
img.save("output/flagsfoxes.png")
