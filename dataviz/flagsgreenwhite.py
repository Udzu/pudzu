...
df = pd.read_csv("datasets/flagsgreenwhite.csv")
...
title = Image.from_text("Some green and white flags".upper(), FONT(80, bold=True), fg=fg, bg=bg).pad(40, bg)
...
img.save("output/flagsgreenwhite.png")
