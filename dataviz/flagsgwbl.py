...
df = pd.read_csv("datasets/flagsgwbl.csv")
...
title = Image.from_text("20 Orange, White & Blue flags".upper(), FONT(80, bold=True), fg=fg, bg=bg).pad(40, bg)
