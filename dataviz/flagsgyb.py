...
df = pd.read_csv("datasets/flagsgyb.csv")
...
title = Image.from_text(f"Green, Yellow and Blue flags".upper(), FONT(N*80, bold=True), fg=fg, bg=bg).pad(N*40, bg)
