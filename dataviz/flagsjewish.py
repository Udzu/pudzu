...
df = pd.read_csv("datasets/flagsjewish.csv")
...
title = Image.from_text(f"Some Jewish flags".upper(), FONT(80, bold=True), fg=fg, bg=bg).pad(40, bg)
...
img.save("output/flagsjewish.png")
