...
df = pd.read_csv("datasets/flagsoy.csv")
...
title = Image.from_text(f"Flags with distinct Yellow & Orange".upper(), FONT(80, bold=True), fg=fg, bg=bg).pad(40, bg)
