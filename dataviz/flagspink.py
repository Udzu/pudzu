...
df = pd.read_csv("datasets/flagspink.csv")
...
title = Image.from_text("Some flags with pink in them".upper(), FONT(80, bold=True), fg=fg, bg=bg).pad(40, bg)
