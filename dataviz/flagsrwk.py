...
df = pd.read_csv("datasets/flagsrwk.csv")
...
title = Image.from_text("50 Red, White & Black flags".upper(), FONT(96, bold=True), fg=fg, bg=bg).pad(40, bg)
