...
df = pd.read_csv("datasets/flagsrwy.csv")
...
title = Image.from_text(f"Red, white and yellow flags".upper(), FONT(80, bold=True), fg=fg, bg=bg).pad(40, bg)
