...
df = pd.read_csv("datasets/flagsryk.csv")
...
title = Image.from_text(f"Black, red and gold flags".upper(), FONT(80, bold=True), fg=fg, bg=bg).pad(40, bg)
