...
df = pd.read_csv("datasets/flagstrees.csv")
...
title = Image.from_text(f"flags with trees".upper(), FONT(80, bold=True), fg=fg, bg=bg).pad(40, bg)
...
img.save("output/flagstrees.png")
