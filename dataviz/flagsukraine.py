...
df = pd.read_csv("datasets/flagsukraine.csv")
...
title = Image.from_text(f"Some Ukrainian flags".upper(), FONT(80, bold=True), fg=fg, bg=bg).pad(40, bg)
...
img.save("output/flagsukraine.png")
