...
df = pd.read_csv("datasets/flagsweapons.csv")
...
title = Image.from_text("Some flags with weapons".upper(), FONT(80, bold=True), fg=fg, bg=bg).pad(40, bg)
...
img.save("output/flagsweapons.png")
