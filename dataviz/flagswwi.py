...
df = pd.read_csv("datasets/flagswwi.csv")
...
FONT = calibri
FONT = partial(font, ( # TODO: add suffix, env selector
	"/usr/share/fonts/truetype/freefont/FreeSans",
	"/usr/share/fonts/truetype/freefont/FreeSansOblique",
	"/usr/share/fonts/truetype/freefont/FreeSansBold",
...
title = Image.from_text("Short-lived European states (1917-25)".upper(), FONT(64, bold=True), fg=fg, bg=bg).pad(30, bg)
