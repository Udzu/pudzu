...
df = pd.read_csv("datasets/g20_drinkingage.csv").set_index("country")
...
chart = bar_chart(df[['min', 'gap', 'illegal']], 40, 600, type=BarChartType.STACKED, bg=None, horizontal=True, spacing=2, label_font=FONT(16), rlabels=rlabel,
    clabels=label, colors= [VegaPalette10.BLUE, RGBA(VegaPalette10.BLUE).brighten(0.2), VegaPalette10.RED],
